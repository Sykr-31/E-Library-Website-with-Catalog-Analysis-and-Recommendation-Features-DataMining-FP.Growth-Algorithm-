<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="permintaan"><i class="fa fa-circle-o"></i>Peminjaman/Pendaftaran</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="laporan-buku"><i class="fa fa-circle-o"></i> <span>Laporan Stok Buku</span></a></li>
                    ...
                    <li><a href="laporan-kartu-anggota"><i class="fa fa-circle-o"></i> <span>Laporan Kartu Anggota</span></a></li>
                    <li><a href="laporan-surat-keterlambatan"><i class="fa fa-circle-o"></i> <span>Laporan Keterlambatan</span></a></li>
                </ul>
            </li>
    ...
    -->
            ...
            <li>
                <a href="fp-growth"><i class="fa fa-line-chart"></i> <span>Analisis FP-Growth</span></a>
            </li>
            <!-- <li>
                <a href="test_pengujian"> <span>Testing Sidang</span></a>
            </li> -->
