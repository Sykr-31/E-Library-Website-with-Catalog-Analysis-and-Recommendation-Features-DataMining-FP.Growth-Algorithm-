    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                $query_petugas = mysqli_query($koneksi, "SELECT * FROM petugas WHERE id_user_lvl = 1");
            ...
            <div class="col-lg-3 col-xs-6">
                <?php
                include "../../config/koneksi.php";
                $query_anggota = mysqli_query($koneksi, "SELECT * FROM anggota WHERE id_user_lvl = 2");
            ...
            <div class="col-lg-3 col-xs-6">
                <?php
                include "../../config/koneksi.php";
                $query_permintaan = mysqli_query($koneksi, "SELECT COUNT(*) AS total_permintaan FROM transaksi WHERE status = 'Menunggu persetujuan !'");
                $data_permintaan = mysqli_fetch_assoc($query_permintaan);
                $total_permintaan = $data_permintaan['total_permintaan'];
                ?>
                <div class="small-box bg-purple">
                    ...
                    <a href="permintaan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
