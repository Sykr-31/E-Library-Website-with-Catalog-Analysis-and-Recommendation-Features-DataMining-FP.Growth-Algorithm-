                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="form-group m-b-2 text-right" style="margin-top: -20px; margin-bottom: -5px;">
                            <button type="button" onclick="tambahPenerbit()" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Data</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-toggle="modal" data-target="#modalEditPenerbit<?= $row['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="pages/function/Penerbit.php?act=hapus&id=<?= $row['id']; ?>" class="btn btn-danger btn-sm btn-del"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Anggota -->
                                    <div class="modal fade" id="modalEditPenerbit<?= $row['id']; ?>">
