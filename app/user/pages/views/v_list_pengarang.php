...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List Pengarang</li>
        </ol>
    </section>
                        ...
                        <form id="List">
                            <div class="form-group">
                                <div class="form-inline my-2 my-lg-0">
                                    <input id="searchInput" class="form-control mr-sm-2" type="search" placeholder="Cari Pengarang . . ." aria-label="Search" style="width: 100%;" oninput="handleSearch()">
                                </div>
                            ...
                            <div class="form-group">
                                <ul class="content-list" style="list-style: none; padding: 0;" id="bookList">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        $letter = htmlspecialchars($row['huruf_awal']);
                                        echo "<li style='margin-bottom: 10px; border-bottom: 1px dotted darkgrey;'>
                                        <h2 style='margin-bottom: 5px; font-family: serif;'>$letter</h2>
                                        ...
                                        $stmt_books->bind_param("s", $letter);
                                        $stmt_books->execute();
                                        ...
                                        while ($book_row = $result_books->fetch_assoc()) {
                                            ...
                                            $encoded_author = urlencode($book_title);
                                            echo "<li>
                                                    <a href='peminjaman-buku?search=&author=$encoded_author'>
                                                        $book_title
                                                    </a>
                                                </li>";
                                        }
