...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <form name="formLogin" action="function/Process.php?aksi=daftar" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                <div class="form-group has-feedback">
                    <input type="number" class="form-control" name="unnis" placeholder="NIS" id="unnis">
                ...
                <div class="form-group has-feedback">
                    <input type="number" class="form-control" name="noHp" placeholder="Nomor Hp" id="noHp">
    ...
    <script>
        function validateForm() {
            if (document.forms["formLogin"]["unnis"].value == "") {
                toastr.error("NIS harus diisi !!");
                document.forms["formLogin"]["unnis"].focus();
                return false;
            }
            ...
            if (document.forms["formLogin"]["noHp"].value == "") {
                toastr.error("Nomor Hp harus diisi !!");
                document.forms["formLogin"]["noHp"].focus();
                return false;
            }
