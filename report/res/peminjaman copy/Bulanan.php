...
<div style="text-align: center;">
    <span class="judul">REKAPITULASI PEMINJAMAN BULANAN</span>
</div>
...
if (isset($_GET['bln_pinjm']) && $_GET['bln_pinjm'] !== '') {
    ...
    $query = "SELECT p.*, pl.id_user, pl.id_buku, u.nama_lengkap AS nama_anggota, b.judul_buku
              ...
              WHERE MONTH(STR_TO_DATE(p.tanggal_peminjaman, '%d-%m-%Y')) = '$bulan' 
              AND YEAR(STR_TO_DATE(p.tanggal_peminjaman, '%d-%m-%Y')) = '$tahun'";
