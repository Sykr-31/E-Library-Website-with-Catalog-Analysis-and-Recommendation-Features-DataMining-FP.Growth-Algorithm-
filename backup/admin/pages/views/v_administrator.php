                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditAdmin<?= $row['id_user']; ?>"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="pages/function/Administrator.php?act=hapus&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm btn-del" onclick="hapusAnggota()"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Admin -->
