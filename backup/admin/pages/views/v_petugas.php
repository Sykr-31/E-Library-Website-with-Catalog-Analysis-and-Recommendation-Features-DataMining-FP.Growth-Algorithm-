                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditPetugas<?= $row['id_user']; ?>"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="pages/function/Petugas.php?act=hapus&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm btn-del" onclick="hapusAnggota()"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Petugas -->
                                    <div class="modal fade" id="modalEditPetugas<?= $row['id_user']; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Petugas.php?act=edit" enctype="multipart/form-data" method="POST">
                                                    <input type="hidden" value="<?= $row['id_user']; ?>" name="id_petugas">
